...
AzanTiming _$AzanTimingFromJson(Map<String, dynamic> json) {
  return _AzanTiming.fromJson(json);
}
...
mixin _$AzanTiming {
  ...
  @JsonKey(ignore: true)
  $AzanTimingCopyWith<AzanTiming> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AzanTimingCopyWith<$Res> {
  factory $AzanTimingCopyWith(
          AzanTiming value, $Res Function(AzanTiming) then) =
      _$AzanTimingCopyWithImpl<$Res, AzanTiming>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AzanTimingCopyWithImpl<$Res, $Val extends AzanTiming>
    implements $AzanTimingCopyWith<$Res> {
  _$AzanTimingCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_AzanTimingCopyWith<$Res>
    implements $AzanTimingCopyWith<$Res> {
  factory _$$_AzanTimingCopyWith(
          _$_AzanTiming value, $Res Function(_$_AzanTiming) then) =
      __$$_AzanTimingCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'Fajr') String? fajr,
...
/// @nodoc
class __$$_AzanTimingCopyWithImpl<$Res>
    extends _$AzanTimingCopyWithImpl<$Res, _$_AzanTiming>
    implements _$$_AzanTimingCopyWith<$Res> {
  __$$_AzanTimingCopyWithImpl(
      _$_AzanTiming _value, $Res Function(_$_AzanTiming) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_AzanTiming implements _AzanTiming {
  const _$_AzanTiming(
  ...
  factory _$_AzanTiming.fromJson(Map<String, dynamic> json) =>
      _$$_AzanTimingFromJson(json);
  ...
  @override
  String toString() {
    return 'AzanTiming(fajr: $fajr, sunrise: $sunrise, dhuhr: $dhuhr, asr: $asr, sunset: $sunset, maghrib: $maghrib, isha: $isha, imsak: $imsak, midnight: $midnight, firstthird: $firstthird, lastthird: $lastthird)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_AzanTimingCopyWith<_$_AzanTiming> get copyWith =>
      __$$_AzanTimingCopyWithImpl<_$_AzanTiming>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_AzanTimingToJson(
      this,
    );
  }
}

abstract class _AzanTiming implements AzanTiming {
  const factory _AzanTiming(
      ...
      @JsonKey(name: 'Lastthird') final String? lastthird}) = _$_AzanTiming;

  factory _AzanTiming.fromJson(Map<String, dynamic> json) =
      _$_AzanTiming.fromJson;
