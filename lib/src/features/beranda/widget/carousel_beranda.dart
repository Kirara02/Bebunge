...
import 'carousel_card_beranda.dart';

class CarouselBeranda extends StatefulWidget {
  const CarouselBeranda({this.listPaths, this.loading = false, super.key});
  final List<BebeliSliderImg>? listPaths;
  final bool loading;

  @override
  State<CarouselBeranda> createState() => _CarouselBerandaState();
}

class _CarouselBerandaState extends State<CarouselBeranda> {
  int currentPos = 0;
            ...
            CarouselSlider.builder(
              ...
              itemBuilder: (context, index, _) {
                return widget.loading
                    ...
                    : CarouselCardBeranda(
                        imgPath: widget.listPaths![index].img);
              },
            ),
            Row(
