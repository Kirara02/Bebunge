...
mixin _$OnboardState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<OnboardMod> data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<OnboardMod> data)? loaded,
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(final List<OnboardMod> data) : _data = data;

  final List<OnboardMod> _data;
  @override
  List<OnboardMod> get data {
  ...
  @override
  String toString() {
    return 'OnboardState.loaded(data: $data)';
  }
...
abstract class _Loaded implements OnboardState {
  const factory _Loaded(final List<OnboardMod> data) = _$_Loaded;
...
class _$_Error implements _Error {
  ...
  @override
  String toString() {
    return 'OnboardState.error(error: $error)';
  }
